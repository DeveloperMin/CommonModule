...
@implementation QuestionTipsView
...
- (void)setUpView {
    ...
    [tipView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(self.mas_width).multipliedBy(0.42);
    }];
...
- (void)clickBtn:(UIButton *)btn {
    [self endEditing:YES];
    if ([self.delegate respondsToSelector:@selector(clickQuestionTipsViewWithBtn:nickName:)]) {
        [self.delegate clickQuestionTipsViewWithBtn:btn nickName:self.textField.text];
    }
}
