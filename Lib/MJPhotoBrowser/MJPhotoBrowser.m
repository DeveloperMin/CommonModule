...
- (void)show
{
    CGRect frame = {{0, 0}, {TXBYApplicationW, TXBYApplicationH + 20}};
    photoWindow = [[UIWindow alloc] initWithFrame:frame];
    photoWindow.windowLevel = UIWindowLevelAlert - 1;
    [photoWindow makeKeyAndVisible];
    photoWindow.rootViewController = [UIViewController new];
    [photoWindow addSubview:self.view];
    [photoWindow.rootViewController addChildViewController:self];
